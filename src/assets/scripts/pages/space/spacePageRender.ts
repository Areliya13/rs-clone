...
export class SpacePageRender extends Page {
  ...
  render() {
    ...
    const tempButtonForModal = createHtmlElement('button', {textContent: 'Временная кнопка для теста модалки (УДАЛИТЬ!)'});
    ...
    const headerText = createHtmlElement('textarea', {className: 'modalHeaderText', textContent: 'Тестовое название'});
    ...
    const cardDetailMembersHead = createHtmlElement('h3', {className: 'modalHeadText modalMembersHead', textContent: 'Участники'});
    ...
    const notificationHead = createHtmlElement('h3', {className: 'modalHeadText modalNotificationHead', textContent: 'Уведомления'});
    const notificationButton = createHtmlElement('button', {className: 'modal-button modalNotificationButton'});
    const notificationButtonIcon = createHtmlElement('div', {className: 'modalNotificationIcon', innerHTML: modalEye});
    const notificationButtonText = createHtmlElement('span', {className: 'modalNotificationText', textContent: 'Подписаться'});
    ...
    const cardDateControlsCheckbox = createHtmlElement('input', {className: 'modalCardDateCheckbox', type: 'checkbox'})
    const cardDateButton = createHtmlElement('button', {className: 'modal-button modalCardDateButton', type: 'button'});
    ...
    const descriptionTextarea = createHtmlElement('textarea', {className: 'modalDescriptionInput', placeholder: 'Добавить более подробное описание...'});
    ...
    const commentTextarea = createHtmlElement('textarea', {className: 'modalCommentTextarea', placeholder: 'Напишите комментарий...'});
    ...
    const sidebarRecommendedHead = createHtmlElement('h3', {className: 'modalHeadText modalRecommendedHead', textContent: 'Рекомендуемые'});
    const sidebarRecommendedUserIcon = createHtmlElement('div', {className: 'modalIcon modalRecommendedButtonIcon', innerHTML: modalUserIcon});
    const sidebarRecommendedText = createHtmlElement('span', {className: 'modalRecommendedButtonText', textContent: 'Присоединится'});
    ...
    const addToCardHead = createHtmlElement('h3', {className: 'modalHeadText modalAddToCardHead', textContent: 'Добавить на карточку'});
    const addToCardButtons = createHtmlElement('div', {className: 'modalAddToCardButtons'});
    const addToCardMembersIcon = createHtmlElement('div', {className: 'modalIcon modalAddToCardMembersIcon', innerHTML: modalUserIcon});
    const addToCardMembersText = createHtmlElement('span', {className: 'modalAddToCardMembersText', textContent: 'Участники'});
    const addToCardMembersButton = createHtmlElement('button', {className: 'modal-button modalAddToCardMembersButton'});
    const tagsButtonIcon = createHtmlElement('div', {className: 'modalIcon modalTagsButtonIcon', innerHTML: tagsIcon});
    ...
    const checklistButtonIcon = createHtmlElement('div', {className: 'modalIcon modalChecklistButtonIcon', innerHTML: checkBoxIcon});
    const checklistButtonText = createHtmlElement('span', {className: 'modalChecklistButtonText', textContent: 'Чек-лист'});
    ...
    const actionsHead = createHtmlElement('h3', {className: 'modalHeadText modalActionsHead', textContent: 'Действия'});
    const actionsButtons = createHtmlElement('div', {className: 'modalActionsButtons'});
    const movingButtonIcon = createHtmlElement('div', {className: 'modalIcon modalMovingButtonIcon', innerHTML: rightIcon});
    const movingButtonText = createHtmlElement('span', {className: 'modalMovingButtonText', textContent: 'Перемещение'});
    const movingButton = createHtmlElement('button', {className: 'modal-button modalMovingButton'});
    const copyingButtonIcon = createHtmlElement('div', {className: 'modalIcon modalCopyingButtonIcon', innerHTML: copyIcon});
    const copyingButtonText = createHtmlElement('span', {className: 'modalCopyingButtonText', textContent: 'Копирование'});
    const copyingButton = createHtmlElement('button', {className: 'modal-button modalCopyingButton'});
    const shareButtonIcon = createHtmlElement('div', {className: 'modalIcon modalShareButtonIcon', innerHTML: shareIcon});
