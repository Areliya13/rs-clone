...
var createIdArray_1 = require("../../utils/createIdArray");
var updateBoardService = function (_a) {
    var title = _a.title, color = _a.color, image = _a.image, boardId = _a.boardId, list = _a.list;
    return __awaiter(void 0, void 0, void 0, function () {
        var board, updatedBoard;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!boardId)
                        throw new Error('boardId not transferred');
